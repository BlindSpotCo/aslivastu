      ...
      <section className="cta-section">
        ...
        <div className="cta-inner">
          ...
          <div className="cta-stats">
            {[['153','areas covered'],['8','dimensions'],['2','cities'],['Free','always']].map(([v,l],i,arr) => (
              <>
                <div key={v}>
